...
<div id="update">
  <div id="content">
     <form name="UpdateUser" action="updateStudentServlet"  method="post" id="submitForm">
         ...
         <div class="group">
	        <div>
               ...
               <input type="text" name="group" class="long inputBox"  value="${TheUser.group}" id="groupName"  />
