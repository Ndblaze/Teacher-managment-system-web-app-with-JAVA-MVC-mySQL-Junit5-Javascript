...
<div class="container">
  <div class="content">
      <form name="deletStudent" action="deleteStudentServlet"  method="post">
        ...
        <hr />
           <div>
            ...
            <div>
                  ...
                  <a href="/DaawMiniProject/StudentListServlet?group=${user.group}" ><input type="button" value="Cancel" class="button"></a>        
